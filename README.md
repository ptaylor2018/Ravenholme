...
- Please download [this config file](https://raw.githubusercontent.com/ptaylor2018/Ravenholme/master/chiselsandbits.cfg) (right click ->save as) and add it to your Curse/Minecraft/Instances/SevTech Ages/config/ directory. (it's for chisels and bits)
